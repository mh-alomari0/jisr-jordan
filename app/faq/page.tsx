  ...
  const faqs = [
    {
      ...
      a: "يمكنك تصفح دليل الخدمات، اختيار الخدمة المطلوبة، وتحديد التاريخ والوقت والعنوان، ثم متابعة الحجز واختيار الدفع عند إكمال الخدمة من صفحة التفاصيل.",
    },
    {
      q: "ما هي وسائل الدفع المتاحة؟",
      a: "الخيار التشغيلي المتاح حالياً هو الدفع النقدي عند إكمال الخدمة. الدفع الإلكتروني غير متاح إلى أن يتم ربط بوابة دفع أردنية معتمدة والتحقق منها.",
    },
    {
      q: "كيف يتم اختيار وتأهيل الفنيين ومزودي الخدمات؟",
      a: "يراجع فريق الإدارة طلب المزود وبيانات ملفه والخدمات التي يقدمها قبل اعتماد الحساب. لا تعني الموافقة إجراء فحص أمني أو تحقق خارجي من الهوية ما لم يُذكر ذلك صراحةً لكل مزود.",
    },
    {
