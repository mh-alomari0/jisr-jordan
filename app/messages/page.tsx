  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
      <section className="relative overflow-hidden rounded-[2.1rem] bg-[#0b817a] p-6 text-white sm:p-8">
        ...
        <div className="absolute -bottom-24 right-[20%] h-52 w-52 rounded-full bg-[#ffc985]/15" />
        <div className="relative">
          ...
          <h1 className="mt-1 text-3xl font-bold tracking-[-.05em] sm:text-5xl">
            احكي، وضّح،
            <span className="text-[#ffc985]"> واتفق براحتك.</span>
          </h1>

          <p className="mt-3 max-w-2xl text-sm leading-7 text-[#d9f2ee]">
            ابعث صور أو فيديو للمشكلة، واسأل مقدم الخدمة عن التفاصيل
            قبل الحجز بدون ما تطلع المحادثة خارج المنصة.
          </p>
        </div>
      </section>
      ...
      <section className="mt-8">
        <div className="mb-5 flex items-end justify-between gap-3">
          <div>
            <p className="text-[10px] font-bold text-brand">صندوق الوارد</p>
            <h2 className="mt-1 text-2xl font-bold">محادثاتك</h2>
          </div>
        ...
        {!result.success ? (
          ...
          <div className="rounded-[1.8rem] border border-dashed border-[rgb(var(--primary)/0.28)] bg-[rgb(var(--primary)/0.025)] px-6 py-14 text-center">
            ...
            <h2 className="mt-5 text-lg font-bold">لسه ما بلشت أي محادثة</h2>
          ...
          <div className="overflow-hidden rounded-[1.8rem] border border-theme bg-surface shadow-soft">
            {result.conversations.map((conversation) => (
              <Link
                ...
                className="group flex min-h-24 items-center gap-3 border-b border-theme px-4 py-4 transition last:border-b-0 hover:bg-surface-muted sm:px-5"
              >
