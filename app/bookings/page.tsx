...
export const metadata = { title: "حجوزاتي | جسر الأردن" };
    ...
    <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
      <section className="relative overflow-hidden rounded-[2.1rem] bg-[#0b817a] px-6 py-8 text-white sm:px-8">
        ...
        <div className="relative">
          ...
          <p className="mt-6 text-[10px] font-bold text-[#c9eee8]">رحلتك مع جسر</p>
          <h1 className="mt-1 text-3xl font-bold tracking-[-.05em] sm:text-5xl">طلباتك كلها، <span className="text-[#ffc985]">بمكان واحد.</span></h1>
          <p className="mt-3 max-w-2xl text-sm leading-7 text-[#d9f2ee]">
            تابع الحجز من لحظة إنشائه لحد التنفيذ والتقييم، واعرف كل تحديث على طلبك.
          </p>
        </div>
      </section>
      ...
      <section className="mt-8">
        <div className="mb-5">
          <p className="text-[10px] font-bold text-brand">متابعة الطلبات</p>
          <h2 className="mt-1 text-2xl font-bold">حجوزاتي</h2>
          <p className="mt-1 text-xs text-muted">{typedBookings.length} طلب مسجل</p>
        </div>
